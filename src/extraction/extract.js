...
function buildExtractionPrompt(type, actionDescription, conversationHistory, user) {
...
async function extractActionSchema(type, actionDescription, conversationHistory, user, timeoutMs) {
  ...
  const { system, user: userPrompt } = buildExtractionPrompt(type, actionDescription, conversationHistory, user);
